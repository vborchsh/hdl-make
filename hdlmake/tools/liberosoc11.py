...
# Original Author: Pawel Szostek (pawel.szostek@cern.ch)
#		  Adopted to LiberoSoC v12.x by Severin Haas (severin.haas@cern.ch)
#		  Adopted to LiberoSoC v11.x by Istvan Kiss (kiss.istvan@remred.hu)
...
"""Module providing support for Microsemi Libero SoC 11.9 (<12.0) synthesis"""


from __future__ import absolute_import
from .makefilesyn import MakefileSyn
from ..sourcefiles.srcfile import VHDLFile, VerilogFile, SDCFile, PDCFile, CXFFile, TCLFile, SourceFile
...
class ToolLiberoSoC11(MakefileSyn):
