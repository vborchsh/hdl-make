...
"""
    ...
    def write_makefile(self, top_manifest, fileset, constrset, filename=None):
...
TCL_CREATE := $(TCL_OPEN)
    ...
    def _makefile_syn_constraints(self):
        ...
        # Add each source file
        self._makefile_syn_files_cmd(constrset_dict)
...
""".format(stage.upper(),
    ...
    def _makefile_syn_help(self):
        """Print help to the Makefile"""
        self.writeln('help:')
        self.writeln('\t\t@echo "This file was generated by hdlmake"')
        self.writeln('\t\t@echo "http://ohwr.org/projects/hdl-make/"')
        self.writeln('\t\t@echo ""')
        self.writeln('\t\t@echo "Available targets:"')
        self.writeln('\t\t@echo "\tproject"')
        self.writeln('\t\t@echo "\tsynthesize"')
        self.writeln('\t\t@echo "\tpar"')
        self.writeln('\t\t@echo "\tbitstream"')
        self.writeln('\t\t@echo "\tprom"')
        self.writeln('\t\t@echo "\tclean"')
        self.writeln('\t\t@echo "\tmrproper"')
        self.writeln('\t\t@echo "\thelp"')
        self.writeln('\t\t@echo ""')
