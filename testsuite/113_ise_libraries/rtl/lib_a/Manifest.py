...
if os.path.islink('axi_regs.vhd'):
        print("lib_a/maintest.py: a symlink to the file exists")
elif os.path.isfile('axi_regs.vhd'):
	print("lib_a/manifest.py: a file with the same name exists...   not sure we should ever see this")
else:
	os.symlink(src, dst)
